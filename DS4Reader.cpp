...
// DS4Reader.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CDS4ReaderApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CDS4ReaderApp

CDS4ReaderApp::CDS4ReaderApp()
{
...
// Единственный объект CDS4ReaderApp

CDS4ReaderApp theApp;


// Инициализация CDS4ReaderApp

BOOL CDS4ReaderApp::InitInstance()
{
